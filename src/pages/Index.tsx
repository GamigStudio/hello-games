...
const Index = () => {
  ...
  // Automatically hide overlay after a certain time or on user interaction
  ...
  return (
    <>
      {showOverlay && (
        ...
        >
          <a 
            href="https://proggl.tech/r1mbxdPj" 
            target="_blank" 
            rel="noopener noreferrer"
            className="block"
          >
            <img 
              src="/lovable-uploads/63b5a0d5-4f33-4cf4-a7df-302f3c6d9d43.png" 
